...
export default function Dolcegabbana() {
    ...
    const getData = async()=>{
        const res = await axios.get(`https://sandlasdata.herokuapp.com/grabinas`)
  ...
  return (
    <>
    <NavBar/>
        <Product_display Data={data} route="/products/Dolce-gabbana/" para10={para10} heading10={heading10} img10={img10} />
        <Footer/>
    </>
  )
}